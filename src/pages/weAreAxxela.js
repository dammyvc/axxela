                    ...
                    <AnimatedOnScroll>
                      ...
                      >
                        <p className="break-words, whitespace-pre-wrap p-0 mb-[0.55em] cursor-text relative text-base font-light text-dark dark:text-light">
                          ...
                          Limited - stands as a beacon of innovation and
                          progress.
                        </p>
                      </motion.div>
                    </AnimatedOnScroll>
                    ...
                    <AnimatedOnScroll>
                      ...
                      >
                        <p className="break-words, whitespace-pre-wrap p-0 mb-[0.55em] cursor-text relative text-base font-light text-dark dark:text-light">
                          ...
                          supply chain, meticulously crafted to deliver
                          efficiency and reliability, ensures seamless
                          transmission of gas from processing stations to
                          distribution companies like ours.
                        </p>
                      </motion.div>
                    </AnimatedOnScroll>
                    ...
                    <AnimatedOnScroll>
                      ...
                      >
                        <p className="break-words, whitespace-pre-wrap p-0 mb-[0.55em] cursor-text relative text-base font-light text-dark dark:text-light">
                          ...
                          <br />
                          Gas suppliers deliver gas through transmission lines
                          to processing stations, where it undergoes
                          purification to remove any impurities, such as liquids
                          and condensates. Once processed, the natural gas is
                          supplied to local distribution companies like Axxela,
                          via pipelines. From there, we distribute the processed
                          natural gas to our customers downstream using
                          pipelines, CNG skids, and other distribution methods.
                          Additionally, Axxela plays a crucial role in supplying
                          gas to Togo through the West Africa Gas Pipeline
                          &#40;WAGP&#41;.
                        </p>
                      </motion.div>
                    </AnimatedOnScroll>
                    ...
                    <AnimatedOnScroll>
                      ...
                      >
                        <h4 className="break-words whitespace-pre-wrap p-0 mb-[0.55em] cursor-text relative text-base font-medium text-dark dark:text-light md:mb-[1.61111em]">
                          ...
                          deeply ingrained in our strategic imperatives, guided
                          by globally recognised standards. Through direct
                          engagement with stakeholders and strategic
                          partnerships, we navigate the complex intersections of
                          economic, environmental, and social impacts arising
                          from our operations.
                          <br />
                          <br />
                          ...
                          sustainability. Looking ahead to 2024, we aim to
                          expand our impact further by awarding scholarships to
                          deserving students, enhancing our{' '}
                          <Tooltip
                            placement="top"
                          ...
                          supply shortages and FX market fluctuations, we remain
                          focused on our mid-term goals, including expanding our
                          natural gas distribution network and exploring
