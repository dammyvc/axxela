...
const about = () => {
  ...
  return (
    <>
      ...
      <Paginator prevLink="/ceoStatement" nextLink="/weAreAxxela" />
      ...
      <main className="flex items-center text-dark w-full min-h-screen">
        <Layout>
                    ...
                    >
                      <p className="break-words whitespace-pre-wrap p-0 mb-[0.55em] cursor-text relative text-base font-light leading-tight text-dark dark:text-light">
                        ...
                        <Link
                          ...
                          target="_blank"
                          className="underline italic text-sustainable"
                        >
                      ...
                      <AnimatedOnScroll>
                        <p className="break-words whitespace-pre-wrap p-0 mb-[0.55em] cursor-text relative text-base font-light leading-tight text-dark dark:text-light">
                          ...
                          of this sustainability report are matched with those
                ...
                <div className="flex relative flex-col grow shrink max-h-full box-border text-start justify-start border-solid border-black border-0 rounded-r-[inherit] basis-[calc(50%-12px)] max-w-[calc(50%-12px)] md:grow-0 md:shrink-0 md:basis-[calc(100%-0px)] md:max-w-[calc(100%-0px)] sm:grow-0 sm:shrink-0 sm:basis-[calc(100%-0px)] sm:max-w-[calc(100%-0px)]">
                  ...
                  >
                    ...
                    >
                      ...
                      <AnimatedOnScroll>
                        <p className="break-words whitespace-pre-wrap p-0 mb-[0.55em] cursor-text relative text-base font-light leading-tight text-dark dark:text-light">
                          This publication aligns with the reporting principles
                          of the GRI Standards, which guide our materiality
                          evaluation, stakeholder engagement, and dualfocused
                          financial and non-financial sustainability reporting.
                          We remain committed to reporting within the parameters
                          of the IFRS Standards for Scope 1 and Scope 2, and we
                          continue to outline our efforts towards the
                          Sustainable Development Goals &#40;SDGs&#41;. The
                          content of this report centres on Axxela&apos;s
                          tangible impacts and its intrinsic value.
                        </p>
                      </AnimatedOnScroll>
                      ...
                      <AnimatedOnScroll>
                        <p className="break-words whitespace-pre-wrap p-0 mb-[0.55em] cursor-text relative text-base font-light leading-tight text-dark dark:text-light">
                          ...
                          &nbsp;by an assurer accredited with ISAE 3000
                          certification, bringing expertise in sustainability
                          report assurance.
                        </p>
                      </AnimatedOnScroll>
                    </motion.div>
          ...
          <Footer prevLink="/ceoStatement" nextLink="/weAreAxxela" />
        </Layout>
      </main>
    </>
  );
